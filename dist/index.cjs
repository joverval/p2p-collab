...
// src/room.ts
var import_simple_peer = __toESM(require("simple-peer"), 1);
...
var P2PRoom = class {
  ...
  connectToHost(offerUrl) {
    ...
    return new Promise((resolve, reject) => {
      const peer = new import_simple_peer.default({ initiator: false, trickle: this._trickle, config: this._rtcConfig });
